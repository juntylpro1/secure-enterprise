...
Events that are generated by an instance of the projects service can be forwarded to an {{site.data.keyword.en_short}} service instance that is available in the same account.
