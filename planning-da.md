...
You can choose to extend a deployable architecture in the **Architecture** section of the catalog details page, or create a new architecture. Select an option from the **How do you want to build this architecture?** menu. 
{: tip}
